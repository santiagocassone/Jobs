...
{
	public class LaborQuoteAutomationOSQViewModel
	{
		...
		public IEnumerable<LookupGeneral> HourTypes { get; set; }
		public IEnumerable<LookupGeneral> HourTypesValues { get; set; }
		...
		public List<CompletedQuotesByServiceProvider> CompletedQuotesByServiceProvider { get; set; }
